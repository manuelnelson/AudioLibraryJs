...
(function(e, t) {
    ...
    function n(t) { return e.less[t.split("/")[1]]; }
    ...
    function w(t, n, i, s) {
        ...
        r.relativeUrls ? r.rootpath ? t.entryPath ? d = b(r.rootpath + y(a.path, t.entryPath)).path : d = r.rootpath : d = a.path : r.rootpath ? d = r.rootpath : t.entryPath ? d = t.entryPath : d = a.path, x(f, t.type, function(e, l) {
            ...
            if (!i && p && l && (new Date(l)).valueOf() === (new Date(p.timestamp)).valueOf()) S(p.css, t), n(null, null, e, t, { local: !0, remaining: s }, f);
            else
                try {
        ...
        }, function(e, t) { throw new Error("Couldn't load " + t + " (" + e + ")"); });
    }
    ...
    function S(e, t, n) {
        ...
        else (function(e) { r.childNodes.length > 0 ? r.firstChild.nodeValue !== e.nodeValue && r.replaceChild(e, r.firstChild) : r.appendChild(e); })(document.createTextNode(e));
        if (n && l) {
            C("saving " + i + " to cache.");
            try {
    ...
    function x(e, t, n, i) {
        ...
        function a(t, n, r) { t.status >= 200 && t.status < 300 ? n(t.responseText, t.getResponseHeader("Last-Modified")) : typeof r == "function" && r(t.status, e); }

        var s = T(), u = o ? r.fileAsync : r.async;
        typeof s.overrideMimeType == "function" && s.overrideMimeType("text/css"), s.open("GET", e, u), s.setRequestHeader("Accept", t || "text/x-less, text/css; q=0.9, */*; q=0.5"), s.send(null), o && !r.fileAsync ? s.status === 0 || s.status >= 200 && s.status < 300 ? n(s.responseText) : i(s.status, e) : u ? s.onreadystatechange = function() { s.readyState == 4 && a(s, n, i); } : a(s, n, i);
    }
    ...
    function k(e, t) {
        ...
        var c = function(e, t, n) { e.extract[t] && a.push(i.replace(/\{line\}/, parseInt(e.line) + (t - 1)).replace(/\{class\}/, n).replace(/\{content\}/, e.extract[t])); };
    ...
    Array.isArray || (Array.isArray = function(e) { return Object.prototype.toString.call(e) === "[object Array]" || e instanceof Array; }), Array.prototype.forEach || (Array.prototype.forEach = function(e, t) {
        var n = this.length >>> 0;
        ...
        return t;
    }), String.prototype.trim || (String.prototype.trim = function() { return String(this).replace(/^\s\s*/, "").replace(/\s\s*$/, ""); });
    var r, i, s;
        ...
        return this.env = t = t || {}, this.optimization = "optimization" in this.env ? this.env.optimization : 1, this.env.filename = this.env.filename || null, p = {
            ...
            parse: function(e, a) {
                ...
                o = u = h = l = 0, s = e.replace(/\r\n/g, "\n"), s = s.replace(/^\uFEFF/, ""), c = function(e) {
                    ...
                    return u != 0 && (x = new O({ index: c - 1, type: "Parse", message: u > 0 ? "missing closing `}`" : "missing opening `{`", filename: t.filename }, t)), e.map(function(e) { return e.join(""); });
                }([[]]);
                if (x) return a(x, t);
                try {
                ...
                this.imports.queue.length > 0 ? v = function(e) { e = x || e, e ? a(e) : a(null, f); } : a(x, f);
            },
            parsers: {
                primary: function() {
                    var e, t = [];
                ...
                entities: {
                    ...
                    literal: function() { return E(this.entities.ratio) || E(this.entities.dimension) || E(this.entities.color) || E(this.entities.quoted) || E(this.entities.unicodeDescriptor); },
                    assignment: function() {
                        var e, t;
                        ...
                        if (n = E(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                            ...
                            do {
                                ...
                                if (u instanceof i.Variable)
                                    if (E(":")) a = x(this.expression, "expected expression"), t.push({ name: u.name, value: a });
                                    else {
                                        if (E(/^\.{3}/)) {
                ...
                entity: function() { return E(this.entities.literal) || E(this.entities.variable) || E(this.entities.url) || E(this.entities.call) || E(this.entities.keyword) || E(this.entities.javascript) || E(this.comment); },
                end: function() { return E(";") || N("}"); },
                alpha: function() {
                    var e;
                ...
                important: function() { if (s.charAt(o) === "!") return E(/^! *important/); },
                sub: function() {
                    var e;
    ...
    if (r.mode === "browser" || r.mode === "rhino") r.Parser.importer = function(e, t, n, r) { !/^([a-z-]+:)?\//.test(e) && t.length > 0 && (e = t[0] + e), w({ href: e, title: e, type: r.mime, contents: r.contents, files: r.files, rootpath: r.rootpath, entryPath: r.entryPath, relativeUrls: r.relativeUrls }, function(e, i, s, o, u, a) { e && typeof r.errback == "function" ? r.errback.call(null, a, t, n, r) : n.call(null, e, i, a); }, !0); };
    (function(e) {

        function t(t) { return e.functions.hsla(t.h, t.s, t.l, t.a); }
        ...
        e.functions = {
            rgb: function(e, t, n) { return this.rgba(e, t, n, 1); },
            rgba: function(t, i, s, o) {
                var u = [t, i, s].map(function(e) { return n(e, 256); });
                return o = r(o), new e.Color(u, o);
            },
            hsl: function(e, t, n) { return this.hsla(e, t, n, 1); },
            hsla: function(e, t, n, i) {

                function u(e) { return e = e < 0 ? e + 1 : e > 1 ? e - 1 : e, e * 6 < 1 ? o + (s - o) * e * 6 : e * 2 < 1 ? s : e * 3 < 2 ? o + (s - o) * (2 / 3 - e) * 6 : o; }

                e = r(e) % 360 / 360, t = r(t), n = r(n), i = r(i);
                var s = n <= .5 ? n * (t + 1) : n + t - n * t, o = n * 2 - s;
                return this.rgba(u(e + 1 / 3) * 255, u(e) * 255, u(e - 1 / 3) * 255, i);
            },
            hsv: function(e, t, n) { return this.hsva(e, t, n, 1); },
            ...
            hue: function(t) { return new e.Dimension(Math.round(t.toHSL().h)); },
            saturation: function(t) { return new e.Dimension(Math.round(t.toHSL().s * 100), "%"); },
            lightness: function(t) { return new e.Dimension(Math.round(t.toHSL().l * 100), "%"); },
            red: function(t) { return new e.Dimension(t.rgb[0]); },
            green: function(t) { return new e.Dimension(t.rgb[1]); },
            blue: function(t) { return new e.Dimension(t.rgb[2]); },
            alpha: function(t) { return new e.Dimension(t.toHSL().a); },
            luma: function(t) { return new e.Dimension(Math.round((.2126 * (t.rgb[0] / 255) + .7152 * (t.rgb[1] / 255) + .0722 * (t.rgb[2] / 255)) * t.alpha * 100), "%"); },
            ...
            greyscale: function(t) { return this.desaturate(t, new e.Dimension(100)); },
            contrast: function(e, t, n, r) { return e.rgb ? (typeof n == "undefined" && (n = this.rgba(255, 255, 255, 1)), typeof t == "undefined" && (t = this.rgba(0, 0, 0, 1)), typeof r == "undefined" ? r = .43 : r = r.value, (.2126 * (e.rgb[0] / 255) + .7152 * (e.rgb[1] / 255) + .0722 * (e.rgb[2] / 255)) * e.alpha < r ? n : t) : null; },
            e: function(t) { return new e.Anonymous(t instanceof e.JavaScript ? t.evaluated : t); },
            escape: function(t) { return new e.Anonymous(encodeURI(t.value).replace(/=/g, "%3D").replace(/:/g, "%3A").replace(/#/g, "%23").replace(/;/g, "%3B").replace(/\(/g, "%28").replace(/\)/g, "%29")); },
            "%": function(t) {
            ...
            unit: function(t, n) { return new e.Dimension(t.value, n ? n.toCSS() : ""); },
            round: function(e, t) {
                var n = typeof t == "undefined" ? 0 : t.value;
                return this._math(function(e) { return e.toFixed(n); }, e);
            },
            ceil: function(e) { return this._math(Math.ceil, e); },
            floor: function(e) { return this._math(Math.floor, e); },
            _math: function(t, n) {
                if (n instanceof e.Dimension) return new e.Dimension(t(parseFloat(n.value)), n.unit);
                if (typeof n == "number") return t(n);
                throw { type: "Argument", message: "argument must be a number" };
            },
            argb: function(t) { return new e.Anonymous(t.toARGB()); },
            percentage: function(t) { return new e.Dimension(t.value * 100, "%"); },
            color: function(t) {
                if (t instanceof e.Quoted) return new e.Color(t.value.slice(1));
                throw { type: "Argument", message: "argument must be a string" };
            },
            iscolor: function(t) { return this._isa(t, e.Color); },
            isnumber: function(t) { return this._isa(t, e.Dimension); },
            isstring: function(t) { return this._isa(t, e.Quoted); },
            iskeyword: function(t) { return this._isa(t, e.Keyword); },
            isurl: function(t) { return this._isa(t, e.URL); },
            ispixel: function(t) { return t instanceof e.Dimension && t.unit === "px" ? e.True : e.False; },
            ispercentage: function(t) { return t instanceof e.Dimension && t.unit === "%" ? e.True : e.False; },
            isem: function(t) { return t instanceof e.Dimension && t.unit === "em" ? e.True : e.False; },
            _isa: function(t, n) { return t instanceof n ? e.True : e.False; },
            ...
            tint: function(e, t) { return this.mix(this.rgb(255, 255, 255), e, t); },
            shade: function(e, t) { return this.mix(this.rgb(0, 0, 0), e, t); }
        };
    })(n("./tree")), function(e) {
        e.colors = {
            aliceblue: "#f0f8ff",
    ...
    }(n("./tree")), function(e) { e.Alpha = function(e) { this.value = e; }, e.Alpha.prototype = { toCSS: function() { return "alpha(opacity=" + (this.value.toCSS ? this.value.toCSS() : this.value) + ")"; }, eval: function(e) { return this.value.eval && (this.value = this.value.eval(e)), this; } }; }(n("../tree")), function(e) {
    ...
    }(n("../tree")), function(e) { e.Assignment = function(e, t) { this.key = e, this.value = t; }, e.Assignment.prototype = { toCSS: function() { return this.key + "=" + (this.value.toCSS ? this.value.toCSS() : this.value); }, eval: function(t) { return this.value.eval ? new e.Assignment(this.key, this.value.eval(t)) : this; } }; }(n("../tree")), function(e) {
        e.Call = function(e, t, n, r) { this.name = e, this.args = t, this.index = n, this.filename = r; }, e.Call.prototype = {
            eval: function(t) {
                var n = this.args.map(function(e) { return e.eval(t); }), r;
                ...
                return new e.Anonymous(this.name + "(" + n.map(function(e) { return e.toCSS(t); }).join(", ") + ")");
            },
            toCSS: function(e) { return this.eval(e).toCSS(); }
        };
    }(n("../tree")), function(e) {
        e.Color = function(e, t) { Array.isArray(e) ? this.rgb = e : e.length == 6 ? this.rgb = e.match(/.{2}/g).map(function(e) { return parseInt(e, 16); }) : this.rgb = e.split("").map(function(e) { return parseInt(e + e, 16); }), this.alpha = typeof t == "number" ? t : 1; }, e.Color.prototype = {
            eval: function() { return this; },
            toCSS: function() { return this.alpha < 1 ? "rgba(" + this.rgb.map(function(e) { return Math.round(e); }).concat(this.alpha).join(", ") + ")" : "#" + this.rgb.map(function(e) { return e = Math.round(e), e = (e > 255 ? 255 : e < 0 ? 0 : e).toString(16), e.length === 1 ? "0" + e : e; }).join(""); },
            ...
            toARGB: function() {
                ...
                return "#" + e.map(function(e) { return e = Math.round(e), e = (e > 255 ? 255 : e < 0 ? 0 : e).toString(16), e.length === 1 ? "0" + e : e; }).join("");
            },
            compare: function(e) { return e.rgb ? e.rgb[0] === this.rgb[0] && e.rgb[1] === this.rgb[1] && e.rgb[2] === this.rgb[2] && e.alpha === this.alpha ? 0 : -1 : -1; }
        };
    }(n("../tree")), function(e) { e.Comment = function(e, t) { this.value = e, this.silent = !!t; }, e.Comment.prototype = { toCSS: function(e) { return e.compress ? "" : this.value; }, eval: function() { return this; } }; }(n("../tree")), function(e) {
        e.Condition = function(e, t, n, r, i) { this.op = e.trim(), this.lvalue = t, this.rvalue = n, this.index = r, this.negate = i; }, e.Condition.prototype.eval = function(e) {
        ...
        e.Dimension = function(e, t) { this.value = parseFloat(e), this.unit = t || null; }, e.Dimension.prototype = {
            eval: function() { return this; },
            toColor: function() { return new e.Color([this.value, this.value, this.value]); },
            toCSS: function() {
                var e = this.value + this.unit;
                return e;
            },
            operate: function(t, n) { return new e.Dimension(e.operate(t, this.value, n.value), this.unit || n.unit); },
            compare: function(t) { return t instanceof e.Dimension ? t.value > this.value ? -1 : t.value < this.value ? 1 : t.unit && this.unit !== t.unit ? -1 : 0 : -1; }
        };
    }(n("../tree")), function(e) {
        e.Directive = function(t, n) { this.name = t, Array.isArray(n) ? (this.ruleset = new e.Ruleset([], n), this.ruleset.allowImports = !0) : this.value = n; }, e.Directive.prototype = {
            toCSS: function(e, t) { return this.ruleset ? (this.ruleset.root = !0, this.name + (t.compress ? "{" : " {\n  ") + this.ruleset.toCSS(e, t).trim().replace(/\n/g, "\n  ") + (t.compress ? "}" : "\n}\n")) : this.name + " " + this.value.toCSS() + ";\n"; },
            eval: function(t) {
                var n = this;
                return this.ruleset && (t.frames.unshift(this), n = new e.Directive(this.name), n.ruleset = this.ruleset.eval(t), t.frames.shift()), n;
            },
            variable: function(t) { return e.Ruleset.prototype.variable.call(this.ruleset, t); },
            find: function() { return e.Ruleset.prototype.find.apply(this.ruleset, arguments); },
            rulesets: function() { return e.Ruleset.prototype.rulesets.apply(this.ruleset); }
        };
    }(n("../tree")), function(e) {
        e.Element = function(t, n, r) { this.combinator = t instanceof e.Combinator ? t : new e.Combinator(t), typeof n == "string" ? this.value = n.trim() : n ? this.value = n : this.value = "", this.index = r; }, e.Element.prototype.eval = function(t) { return new e.Element(this.combinator, this.value.eval ? this.value.eval(t) : this.value, this.index); }, e.Element.prototype.toCSS = function(e) {
            var t = this.value.toCSS ? this.value.toCSS(e) : this.value;
            return t == "" && this.combinator.value.charAt(0) == "&" ? "" : this.combinator.toCSS(e || {}) + t;
        }, e.Combinator = function(e) { e === " " ? this.value = " " : this.value = e ? e.trim() : ""; }, e.Combinator.prototype.toCSS = function(e) { return { "": "", " ": " ", ":": " :", "+": e.compress ? "+" : " + ", "~": e.compress ? "~" : " ~ ", ">": e.compress ? ">" : " > ", "|": e.compress ? "|" : " | " }[this.value]; };
    }(n("../tree")), function(e) { e.Expression = function(e) { this.value = e; }, e.Expression.prototype = { eval: function(t) { return this.value.length > 1 ? new e.Expression(this.value.map(function(e) { return e.eval(t); })) : this.value.length === 1 ? this.value[0].eval(t) : this; }, toCSS: function(e) { return this.value.map(function(t) { return t.toCSS ? t.toCSS(e) : ""; }).join(" "); } }; }(n("../tree")), function(e) {
        e.Import = function(t, n, r, i, s, o) {
            var u = this;
            this.once = i, this.index = s, this._path = t, this.features = r && new e.Value(r), this.rootpath = o, t instanceof e.Quoted ? this.path = /(\.[a-z]*$)|([\?;].*)$/.test(t.value) ? t.value : t.value + ".less" : this.path = t.value.value || t.value, this.css = /css([\?;].*)?$/.test(this.path), this.css || n.push(this.path, function(t, n, r) { t && (t.index = s), r && u.once && (u.skip = r), u.root = n || new e.Ruleset([], []); });
        }, e.Import.prototype = {
            toCSS: function(e) {
        ...
        e.JavaScript = function(e, t, n) { this.escaped = n, this.expression = e, this.index = t; }, e.JavaScript.prototype = {
            eval: function(t) {
                var n, r = this, i = {}, s = this.expression.replace(/@\{([\w-]+)\}/g, function(n, i) { return e.jsify((new e.Variable("@" + i, r.index)).eval(t)); });
                try {
                    s = new Function("return (" + s + ")");
                } catch(o) {
                    throw { message: "JavaScript evaluation error: `" + s + "`", index: this.index };
                }
                for (var u in t.frames[0].variables()) i[u.slice(1)] = { value: t.frames[0].variables()[u].value, toJS: function() { return this.value.eval(t).toCSS(); } };
                try {
                    n = s.call(i);
                } catch(o) {
    ...
    }(n("../tree")), function(e) { e.Keyword = function(e) { this.value = e; }, e.Keyword.prototype = { eval: function() { return this; }, toCSS: function() { return this.value; }, compare: function(t) { return t instanceof e.Keyword ? t.value === this.value ? 0 : 1 : -1; } }, e.True = new e.Keyword("true"), e.False = new e.Keyword("false"); }(n("../tree")), function(e) {
        e.Media = function(t, n) {
            ...
            evalNested: function(t) {
                ...
                return this.features = new e.Value(this.permute(i).map(function(t) {
                    t = t.map(function(t) { return t.toCSS ? t : new e.Anonymous(t); });
            ...
            bubbleSelectors: function(t) { this.ruleset = new e.Ruleset(t.slice(0), [this.ruleset]); }
        };
    }(n("../tree")), function(e) {
        e.mixin = {}, e.mixin.Call = function(t, n, r, i, s) { this.selector = new e.Selector(t), this.arguments = n, this.index = r, this.filename = i, this.important = s; }, e.mixin.Call.prototype = {
            eval: function(t) {
                var n, r, i, s = [], o = !1, u, a, f, l, c;
                i = this.arguments && this.arguments.map(function(e) { return { name: e.name, value: e.value.eval(t) }; });
        ...
        }, e.mixin.Definition = function(t, n, r, i, s) { this.name = t, this.selectors = [new e.Selector([new e.Element(null, t)])], this.params = n, this.condition = i, this.variadic = s, this.arity = n.length, this.rules = r, this._lookups = {}, this.required = n.reduce(function(e, t) { return !t.name || t.name && !t.value ? e + 1 : e; }, 0), this.parent = e.Ruleset.prototype, this.frames = []; }, e.mixin.Definition.prototype = {
            toCSS: function() { return ""; },
            variable: function(e) { return this.parent.variable.call(this, e); },
            ...
            matchCondition: function(e, t) { return this.condition && !this.condition.eval({ frames: [this.evalParams(t, { frames: this.frames.concat(t.frames) }, e, [])].concat(t.frames) }) ? !1 : !0; },
        ...
        e.Operation = function(e, t) { this.op = e.trim(), this.operands = t; }, e.Operation.prototype.eval = function(t) {
    ...
    }(n("../tree")), function(e) { e.Paren = function(e) { this.value = e; }, e.Paren.prototype = { toCSS: function(e) { return "(" + this.value.toCSS(e) + ")"; }, eval: function(t) { return new e.Paren(this.value.eval(t)); } }; }(n("../tree")), function(e) {
        e.Quoted = function(e, t, n, r) { this.escaped = n, this.value = t || "", this.quote = e.charAt(0), this.index = r; }, e.Quoted.prototype = {
            toCSS: function() { return this.escaped ? this.value : this.quote + this.value + this.quote; },
            eval: function(t) {
                var n = this, r = this.value.replace(/`([^`]+)`/g, function(r, i) { return (new e.JavaScript(i, n.index, !0)).eval(t).value; }).replace(/@\{([\w-]+)\}/g, function(r, i) {
    ...
    }(n("../tree")), function(e) { e.Ratio = function(e) { this.value = e; }, e.Ratio.prototype = { toCSS: function(e) { return this.value; }, eval: function() { return this; } }; }(n("../tree")), function(e) { e.Rule = function(t, n, r, i, s) { this.name = t, this.value = n instanceof e.Value ? n : new e.Value([n]), this.important = r ? " " + r.trim() : "", this.index = i, this.inline = s || !1, t.charAt(0) === "@" ? this.variable = !0 : this.variable = !1; }, e.Rule.prototype.toCSS = function(e) { return this.variable ? "" : this.name + (e.compress ? ":" : ": ") + this.value.toCSS(e) + this.important + (this.inline ? "" : ";"); }, e.Rule.prototype.eval = function(t) { return new e.Rule(this.name, this.value.eval(t), this.important, this.index, this.inline); }, e.Rule.prototype.makeImportant = function() { return new e.Rule(this.name, this.value, "!important", this.index, this.inline); }, e.Shorthand = function(e, t) { this.a = e, this.b = t; }, e.Shorthand.prototype = { toCSS: function(e) { return this.a.toCSS(e) + "/" + this.b.toCSS(e); }, eval: function() { return this; } }; }(n("../tree")), function(e) {
        e.Ruleset = function(e, t, n) { this.selectors = e, this.rules = t, this._lookups = {}, this.strictImports = n; }, e.Ruleset.prototype = {
            eval: function(t) {
                var n = this.selectors && this.selectors.map(function(e) { return e.eval(t); }), r = new e.Ruleset(n, this.rules.slice(0), this.strictImports), i;
            ...
            makeImportant: function() { return new e.Ruleset(this.selectors, this.rules.map(function(e) { return e.makeImportant ? e.makeImportant() : e; }), this.strictImports); },
            matchArgs: function(e) { return !e || e.length === 0; },
            resetCache: function() { this._rulesets = null, this._variables = null, this._lookups = {}; },
            variables: function() { return this._variables ? this._variables : this._variables = this.rules.reduce(function(t, n) { return n instanceof e.Rule && n.variable === !0 && (t[n.name] = n), t; }, {}); },
            variable: function(e) { return this.variables()[e]; },
            rulesets: function() { return this._rulesets ? this._rulesets : this._rulesets = this.rules.filter(function(t) { return t instanceof e.Ruleset || t instanceof e.mixin.Definition; }); },
            find: function(t, n) {
                n = n || this;
                var r = [], i, s, o = t.toCSS();
            ...
            toCSS: function(t, n) {
                ...
                if (this.root) r.push(i.join(n.compress ? "" : "\n"));
                    ...
                    f = e.debugInfo(n, this), a = u.map(function(e) { return e.map(function(e) { return e.toCSS(n); }).join("").trim(); }).join(n.compress ? "," : ",\n");
                    for (var c = i.length - 1; c >= 0; c--) s.indexOf(i[c]) === -1 && s.unshift(i[c]);
                    i = s, r.push(f + a + (n.compress ? "{" : " {\n  ") + i.join(n.compress ? "" : "\n  ") + (n.compress ? "}" : "\n}\n"));
                }
                return r.push(o), r.join("") + (n.compress ? "\n" : "");
            },
            joinSelectors: function(e, t, n) { for (var r = 0; r < n.length; r++) this.joinSelector(e, t, n[r]); },
        ...
        e.Selector = function(e) { this.elements = e; }, e.Selector.prototype.match = function(e) {
            ...
            return !0;
        }, e.Selector.prototype.eval = function(t) { return new e.Selector(this.elements.map(function(e) { return e.eval(t); })); }, e.Selector.prototype.toCSS = function(e) { return this._css ? this._css : (this.elements[0].combinator.value === "" ? this._css = " " : this._css = "", this._css += this.elements.map(function(t) { return typeof t == "string" ? " " + t.trim() : t.toCSS(e); }).join(""), this._css); };
    }(n("../tree")), function(e) { e.UnicodeDescriptor = function(e) { this.value = e; }, e.UnicodeDescriptor.prototype = { toCSS: function(e) { return this.value; }, eval: function() { return this; } }; }(n("../tree")), function(e) {
        e.URL = function(e, t) { this.value = e, this.rootpath = t; }, e.URL.prototype = {
            toCSS: function() { return "url(" + this.value.toCSS() + ")"; },
            eval: function(t) {
                var n = this.value.eval(t), r;
                return typeof n.value == "string" && !/^(?:[a-z-]+:|\/)/.test(n.value) && (r = this.rootpath, n.quote || (r = r.replace(/[\(\)'"\s]/g, function(e) { return "\\" + e; })), n.value = r + n.value), new e.URL(n, this.rootpath);
            }
        };
    }(n("../tree")), function(e) { e.Value = function(e) { this.value = e, this.is = "value"; }, e.Value.prototype = { eval: function(t) { return this.value.length === 1 ? this.value[0].eval(t) : new e.Value(this.value.map(function(e) { return e.eval(t); })); }, toCSS: function(e) { return this.value.map(function(t) { return t.toCSS(e); }).join(e.compress ? "," : ", "); } }; }(n("../tree")), function(e) {
        e.Variable = function(e, t, n) { this.name = e, this.index = t, this.file = n; }, e.Variable.prototype = {
            eval: function(t) {
                var n, r, i = this.name;
                ...
                this.evaluating = !0;
                if (n = e.find(t.frames, function(e) { if (r = e.variable(i)) return r.value.eval(t); })) return this.evaluating = !1, n;
    ...
    a && (r.dumpLineNumbers = a[1]), r.watch = function() { return r.watchMode || (r.env = "development", f()), this.watchMode = !0; }, r.unwatch = function() { return clearInterval(r.watchTimer), this.watchMode = !1; }, /!watch/.test(location.hash) && r.watch();
    var l = null;
    ...
    r.modifyVars = function(e) {
        ...
        (new r.Parser).parse(t, function(e, t) { S(t.toCSS(), r.sheets[r.sheets.length - 1]); });
    }, r.refresh = function(e) {
        var t, n;
        t = n = new Date, g(function(e, r, i, s, o) { o.local ? C("loading " + s.href + " from cache.") : (C("parsed " + s.href + " successfully."), S(r.toCSS(), s, o.lastModified)), C("css for " + s.href + " generated in " + (new Date - n) + "ms"), o.remaining === 0 && C("css generated in " + (new Date - t) + "ms"), n = new Date; }, e), m();
    }, r.refreshStyles = m, r.refresh(r.env === "development"), typeof define == "function" && define.amd && define("less", [], function() { return r; });
})(window);